  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    return (
      ...
      <form onSubmit={handleSubmit} className="mx-auto w-full pt-10 sm:w-3/4">
        <div className="flex flex-col md:flex-row">
          <input
            ...
            className="mr-3 w-full md:w-1/2 lg:mr-5 rounded border-gray-200 bg-gray-50 px-4 py-3 font-body text-gray-800"
            placeholder="Name"
            type="text"
            id="name"
            required
          ...
          <input
            ...
            onChange={handleChange}
            className="mt-6 md:mt-0 md:ml-3 w-full md:w-1/2 lg:ml-5 rounded border-gray-200 bg-gray-50 px-4 py-3 font-body text-gray-800"
            placeholder="Email"
            type="email"
            id="email"
            required
        ...
        <textarea
          ...
          onChange={handleChange}
          className="mt-6 w-full rounded border-gray-200 bg-gray-50 px-4 py-3 font-body text-gray-800 md:mt-8"
          placeholder="Message"
          id="message"
          required
        ></textarea>
        <button
          type="submit"
          className={`mt-6 flex items-center justify-center rounded bg-blue-500 px-8 py-3 font-header text-lg font-bold uppercase text-white hover:bg-blue-600 ${isSubmitting ? 'cursor-wait opacity-75' : ''}`}
      ...
      <div className="flex flex-col pt-16 lg:flex-row">
        <div className="w-full lg:w-1/2 border border-gray-200 bg-gray-50 px-6 py-6 sm:py-8">
          ...
          <p className="pt-2 text-left font-body font-bold text-blue-600 lg:text-lg">
            (+62) 812-9076-5711
          </p>
        </div>
        <div className="w-full lg:w-1/2 border border-gray-200 bg-gray-50 px-6 py-6 sm:py-8 mt-6 lg:mt-0 lg:border-l-0 lg:border-t lg:border-r">
          <div className="flex items-center">
